...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        Ogrenci ogrenci = new Ogrenci { Ad = "Arda", Dersler = new string[] { "Algoritma", "Yazılım", "Tasarım" }, DersSayisi = 3 };
        Ogretmen ogretmen = new Ogretmen { Ad = "Arman", VerdigiDersler = new string[] { "Algoritma", "Yazılım", "Tasarım" }, DersSayisi = 3 };
        Sinif sinif = new Sinif { SinifAdi = "12A", Dersler = new string[] { "Algoritma", "Yazılım", "Tasarım" }, DersSayisi = 3 };
