...
namespace Proje2
{
    ...
    class StackYapısı
    {
        ...
        public void print()
        {
            ...
            {
                // Stack'teki elemanlar yazdırılır
                Node temp = top;
                while (temp != null)
                {
                    Console.WriteLine(temp.data); // Eleman yazdırılır
                    temp = temp.next; // Bir sonraki node'a geçilir
                }
            }
        }

        // topPrint metodu: Stack'teki en üst elemanı yazdırır
        public void topPrint()
        {
            ...
            {
                Console.WriteLine(top.data); // En üst eleman yazdırılır
            }
        }
    }
}
